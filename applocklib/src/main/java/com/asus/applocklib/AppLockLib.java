...
public class AppLockLib {
    ...
    public static void showActivateDialog(FragmentManager fm, String pkg) {
        new ActivateDialog().newInstance(pkg).show(fm, "ActivateDialog");
    }

    public static void showUpgradeDialog(FragmentManager fm) {
        new ActivateDialog().show(fm, "ActivateDialog");
    }
